...
require_once '/home2/katiegil/public_html/includes/configure.php';
/*
****************************************************************************
...
/* Global var for whether accessed on the Nook HD+ Timeclock or mobile device  */

$is_tablet = (strpos($_SERVER['HTTP_USER_AGENT'], 'Android') > -1 ||
			  strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone') > -1 ||
			  strpos($_SERVER['HTTP_USER_AGENT'], 'iPod') > -1 ||
			  strpos($_SERVER['HTTP_USER_AGENT'], 'iPad') > -1) ? true : false;
...
$logo = "images/logos/CTD_initials.png";
