...
ALTER TABLE `jobs` ADD `disabled` TINYINT(1) NOT NULL default '0';
...
ALTER TABLE `jobs` ADD `displayname` VARCHAR(50) NOT NULL default '';
ALTER TABLE `jobs` ADD `email` VARCHAR(75) NOT NULL default '';
ALTER TABLE `jobs` ADD `groups` VARCHAR(50) NOT NULL default '';
ALTER TABLE `jobs` ADD `office` VARCHAR(50) NOT NULL default '';
ALTER TABLE `jobs` ADD `admin` TINYINT(1) NOT NULL default '0';
ALTER TABLE `jobs` ADD `reports` TINYINT(1) NOT NULL default '0';
ALTER TABLE `jobs` ADD `time_admin` TINYINT(1) NOT NULL default '0';
ALTER TABLE `jobs` ADD `disabled` TINYINT(1) NOT NULL default '0';
INSERT INTO jobs VALUES ('admin', NULL, 'xy.RY2HT1QTc2', 'administrator', '', '', '', 1, 1, 1, '');
