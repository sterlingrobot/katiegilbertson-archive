...
<html lang="en" ng-app="klgApp" ng-controller="AppController as app">
    <head>
        ...
        <style>
            /*md-grid-tile { background: rgba(0,0,0,0.3); transition: all 400ms ease-out 50ms; }*/
        </style>
...
<?php endif; ?>
    ...
    <body>
        ...
        <div ng-controller="ProjectController as projects">
            <md-grid-list
                md-cols="3" md-cols-md="4" md-cols-gt-md="8"
                md-row-height-gt-md="1:1" md-row-height="4:3"
                md-gutter="8px" md-gutter-gt-sm="4px"
                md-on-layout="console.log('layout')">

                <md-grid-tile ng-repeat="project in projects.projects" ng-click="projects.setCurrProject(project);">
                    <md-content>
