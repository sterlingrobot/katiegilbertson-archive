...
var nicEditorConfig = bkClass.extend({
	...
	iconList : {"bgcolor":1,"forecolor":2,"bold":3,"center":4,"hr":5,"indent":6,"italic":7,"justify":8,"left":9,"ol":10,"outdent":11,"right":12,"save":23,"strikethrough":14,"subscript":15,"superscript":16,"ul":17,"underline":18,"image":19,"link":20,"unlink":21,"close":22,"arrow":24, "removeformat":26, "xhtml": 25}
...
nicEditor = nicEditor.extend({
        ...
        reposition : function() {
                ...
                var top = $(e).position().top - $(this.floating).height();//e.offsetTop-this.floating.offsetHeight;
                if(top < 0) {
                        top = $(e).position().top + $(e).height();//e.offsetTop+e.offsetHeight;
                }
                this.floating.setStyle({ top : top+'px', left : $(e).position().left+'px' /*e.offsetLeft+'px'*/, display : 'block' });
        },
